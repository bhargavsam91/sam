...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "Dear Cuto.. Everyday day I cannot believe how lucky I am",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "You are the reason for every smile and success",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 1800 && frameNumber < 2100) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "With every beat of my heart I am reminded of the joy you bring",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "I cherish the thought of building a future together \n",
          "filled with endless adventures and constant companionship",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "I cherish the thought of building a future together filled with endless love & constant companionship",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 2700 && frameNumber < 3000) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "I cherish the thought of building a future together",
          "filled with endless love & constant companionship",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
